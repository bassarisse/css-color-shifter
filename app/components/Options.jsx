            ...
            <div>
                ...
                <BigOptionBox>
                    ...
                    <OptionLineContainer>
                        ...
                        {this.renderSliderControl('alphaChange', props.fixAlpha ? 0 : -1, 1, { sliderStep: 0.0001, fieldStep: 0.1 })}
                ...
                <OptionBox>
                    <OptionLine>
                        ...
                        <select name='outputFormat' value={props.outputFormat} onChange={this.changeOptionField}>
                    ...
                    <OptionLine>
                        Post processing<br />
                        <select name='postProcessing' value={props.postProcessing} onChange={this.changeOptionField}>
