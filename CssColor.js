...
var CssColor = Class.extend({
    ...
    setup: function(colorStr) {

        colorStr = CssColor.colorNames[colorStr.toLowerCase()] || colorStr;
    ...
    getValue: function (options) {
        ...
        if (options.colorNames) {
            ...
            for (var n in CssColor.colorNames) {
                if (colorName === CssColor.colorNames[n].toLowerCase()) {
                    returnStr = n;
                    break;
                }
            }
